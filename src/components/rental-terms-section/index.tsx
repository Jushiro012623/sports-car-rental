...
export const RentalTermsSection = () => {
    return (
        <section className="max-w-8xl px-6 sm:px-10 mx-auto mt-52">
            <div
                ...
                <div className="grid grid-cols-2 grid-rows-2 gap-5">
                    {rentalRequirements.map(({id, requirement, icon: Icon, description}) => (
                        <div key={id} className="bg-container-elevated rounded-3xl p-10 flex justify-center flex-col gap-5">
